...
classes = [
    ...
    source.anim.import_anim.SUB_MT_animation_folders,
    source.anim.import_anim.SUB_OP_switch_animation_folder,
    ...
    source.model.material.reimport_materials.SUB_OP_copy_materials_from_armature,
